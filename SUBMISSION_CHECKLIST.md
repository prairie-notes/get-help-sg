...
All project, documentation and deployment work that can be completed inside the repository is ready. The remaining items require the entrant's voice, external accounts or an in-app `/feedback` action.
